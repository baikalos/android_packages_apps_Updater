...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.baikalos.build.version";
    public static final String PROP_DEVICE = "ro.baikalos.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "baikalos.updater.allow_downgrading";
